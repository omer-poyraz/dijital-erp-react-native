...
import { fetchAssemblyFailureGetAllByQuality } from "../../redux/slices/assemblyFailureGetAllByQualitySlice";
...
const AssemblyQualityPage = () => {
    ...
    const { data: failureData, status } = useSelector(state => state.assemblyFailureGetAllByQuality);
    ...
    const getData = async () => {
        await dispatch(fetchAssemblyFailureGetAllByQuality());
    }
