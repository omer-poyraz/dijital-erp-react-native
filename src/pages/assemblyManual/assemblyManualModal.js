...
import { StyleSheet, Text, TouchableOpacity, View, ScrollView, Image, Dimensions, FlatList } from 'react-native'
import { colors } from '../../utilities/colors'
import { Button, Card, Divider, Chip, Badge, ActivityIndicator } from 'react-native-paper'
        ...
        return (
            ...
            >
                <View style={styles.imageContainer}>
                    <Image
                        source={{ uri: `https://api.dijitalerp.com${file}` }}
                                ...
                                <>
                                    ...
                                    {selectedImage ? (
                                        <View style={styles.selectedImageContainer}>
                                            ...
                                            <Image
                                                source={{ uri: `https://api.dijitalerp.com${selectedImage}` }}
...
const styles = StyleSheet.create({
    ...
    projectBadge: { backgroundColor: 'rgba(255,255,255,0.3)', color: '#fff', marginTop: 4, fontSize: 12, },
    closeBtn: { padding: 4, },
    close: { color: '#fff', },
    ...
    selectedImageContainer: { flex: 1, backgroundColor: '#000', borderRadius: 8, overflow: 'hidden', marginBottom: 8, },
