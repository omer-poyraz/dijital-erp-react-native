...
import { fetchCMMFailureGet } from '../../redux/slices/cmmFailureGetSlice'
import { useNavigation } from '@react-navigation/native'

const CMMFailureDetailPage = ({ route }) => {
    const { id } = route.params;
    const { t } = useTranslation();
    const data = useSelector(state => state.cmmFailureGet.data);
    ...
    const getData = async () => {
        await dispatch(fetchCMMFailureGet({ id: id }));
    }
...
export default CMMFailureDetailPage;